...
int main(void)
{
    ...
    {
        fprintf(f, "{\n");
        emit_hex(f, "priv", PRIV_KEY, 32);
        fprintf(f, ",\n");
        emit_hex(f, "msg_asIs", MSG_ASIS, 32);
        fprintf(f, ",\n");
        emit_hex(f, "msg_rev", msgRev, 32);
        fprintf(f, ",\n");
        emit_hex(f, "pub_x", pub_x, 32);
        fprintf(f, ",\n");
        emit_hex(f, "pub_y", pub_y, 32);
        fprintf(f, ",\n");
        fprintf(f, "    \"sigA\": {\n");
        emit_hex(f, "r8x", sigA + 0, 32);
        fprintf(f, ",\n");
        emit_hex(f, "r8y", sigA + 32, 32);
        fprintf(f, ",\n");
        emit_hex(f, "s", sigA + 64, 32);
        fprintf(f, "\n    },\n");
        fprintf(f, "    \"sigB\": {\n");
        emit_hex(f, "r8x", sigB + 0, 32);
        fprintf(f, ",\n");
        emit_hex(f, "r8y", sigB + 32, 32);
        fprintf(f, ",\n");
        emit_hex(f, "s", sigB + 64, 32);
        fprintf(f, "\n    }\n");
        fprintf(f, "}\n");
        fclose(f);
